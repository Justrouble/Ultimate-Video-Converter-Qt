...
void AddFile::on_btnSelectFile_clicked() {
    QFileDialog k(this);
    QString fileName = k.getOpenFileName(this, tr("Add File"), QDir::homePath(), tr("Files (*.*)"));
    if(fileName != 0) {
...
void AddFile::on_btnSetOutputDirectory_clicked() {
    QString tempSave = QFileDialog::getExistingDirectory(this, "Open Directory", ui->txtOutputDir->text(), QFileDialog::ShowDirsOnly);
